...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapse">
  ...
  $sess = $_SESSION['id'];
  $result = $koneksi->query("SELECT * FROM data_customer WHERE id='$sess'");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pengaturan Struk</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container">
        <div class="card card-primary">
          <div class="card-body">
                <form action="?part-customer=update-sett-receipt" method="post" enctype="multipart/form-data">
                    <div class="row pt-3">
                        <div class="col-md-5">
                            <div class="form-group has-danger">
                            <label class="control-label">Nama Vendor</label>
                            <input type="text" class="form-control" style="border-radius:15px;" name="vendor" value="<?php echo $vendor; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row pt-3">

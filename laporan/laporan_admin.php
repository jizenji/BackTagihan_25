...
if (isset($_GET['bulan'],$_GET['tahun'])) {
  ...
  $result = $koneksi->query("SELECT * FROM laporan_absen INNER JOIN tb_kelas_x ON tb_kelas_x.id_kelas_x = laporan_absen.id_kelas WHERE id_angkatan='1' AND status='Y' ORDER BY id_laporan DESC");
}
?>
<html>
<head>
        ...
        <div class="table-responsive">
          <table id="example1" class="table table-striped">
            ...
            <tbody>
              <?php
                $no = 1;
                $resultt = $koneksi->query("SELECT * FROM laporan_a ORDER BY id_laporan DESC");

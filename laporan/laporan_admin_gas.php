...
if (isset($_GET['bulan'],$_GET['tahun'])) {
  ...
  $result = $koneksi->query("SELECT * FROM laporan_a WHERE jenis_meter='gas' ORDER BY id_laporan DESC");
}
?>
<html>
<head>
          ...
          <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Laporan Transaksi Gas</li>
              </ol>
           </div>
         </div>
       </div>
        ...
        <div class="table-responsive">
          <table id="example1" class="table table-striped">
            ...
            <tbody>
              <?php
                $no = 1;
                $resultt = $koneksi->query("SELECT * FROM laporan_a WHERE jenis_meter='gas' ORDER BY id_laporan DESC");

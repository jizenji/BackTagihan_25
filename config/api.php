...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapse">
  ...
  $result = $koneksi->query("SELECT * FROM api ORDER BY id DESC LIMIT 1");
    ...
    <section class="content">
      <div class="container">
        <div class="card card-primary">
          <div class="card-body">
              <form action="?config=proses-api" method="post">
                
                  <div class="row pt-3">
                    <div class="col-md-5">
                      <div class="form-group has-danger">
                      <label class="control-label">Api Whatsaap</label>
                        <input type="text" class="form-control" style="border-radius:15px;"  placeholder="Masukkan Api Whatsaap" name="api" autocomplete="off" value="<?php echo $apii; ?>">
                      </div>
                    </div>
                  </div>

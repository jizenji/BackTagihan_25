                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card bg-light">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                    <h2 class="lead"><b>Jizenji T Wirastomo</b></h2><br>
                                    <p class="text-muted text-sm"><b>About: </b> Developer  </p>
                                    <ul class="ml-3 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Harapanjaya Blok D.41 Bekasi Utara Jawa Barat, 17124</li><br>
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone /  Whatsapp: +62857-2050-5555</li>
                                    </ul>
                                    </div>
                                ...
                                <div class="card-footer">
                                  <div class="text-right">
                                    <a href="https://api.whatsapp.com/send?phone=6285720505555&text=Hallo%20Admin" class="btn btn-sm bg-teal">
